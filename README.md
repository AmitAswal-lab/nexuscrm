...
See [Document sharing](docs/document-sharing.md) for how documents are
published, why files are never attached from a device, and how expiring links
are served and revoked.
